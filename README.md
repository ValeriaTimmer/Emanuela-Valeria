...
# SpringBoot REST API OpenWeather OOP
 ...
 SpringBoot che effettua la chiamata al sito di OpenWeather. I nuovi dati vengono salvati nel file *parsing.json*. 
 Il file *fileValue.json*, invece costituisce uno storico.
