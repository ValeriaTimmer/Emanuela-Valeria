...
public interface CityService {
	 ...
	 */
	public abstract Collection <DownloadCity> getMetadata();
	
	/**
	 * Metodo che permette di selezionare le città filtrate
	 * @return insieme delle città filtrate
	 */
	public abstract Collection <DownloadCity> getCityFiltered(String city, String state);
	
	/**
	 * Metodo che permette di selezionare le statistiche dell'umidità
	 * @return insieme delle statistiche effettute sull'umidità
	 */
	public abstract Collection <DownloadCity> getStatistics(String type, String datainiziale, String datafinale);
	 ...
	 * @return insieme delle città filtrate 
	 */
	public abstract Collection <DownloadCity> getHumidityFiltered (String param1, String param2);
	 ...
	 * @return insieme delle città filtrate 
	 */
	public abstract Collection <DownloadCity> getTemperatureFiltered (String param1, String param2);
	 ...
	 * @return insieme delle città filtrate
	 */
	 public abstract Collection <DownloadCity> getWeatherFiltered (String weather, String city);
